...
/**
 * Created by a rahuul on 4/18/2016.
 */
public class MyDetailActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (isConnected) {
            ...
            if(i.hasExtra("STOCK_SYMBOL")) {
                symbol = i.getStringExtra("STOCK_SYMBOL");
                stockSymbolTV = (TextView) findViewById(R.id.stock_symbol_tv);
                stockSymbolTV.setText(symbol);

                FetchQuoteDetailsTask task = new FetchQuoteDetailsTask();
                task.execute(symbol);
            }
    ...
    public class FetchQuoteDetailsTask extends AsyncTask<String, Void, BuildChart> {
        @Override
